...
import com.test.model.Masterdata;
import com.test.model.Premiumterm;
import com.test.model.RiderModel;
import com.test.model.Startdate;
...
public class siModel {
	...
	public List<RiderModel> getRider() {
		return rider;
	}

	public void setRider(List<RiderModel> rider) {
		this.rider = rider;
	}
